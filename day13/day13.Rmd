...
# Systematic effects 
We will estimate the effects of age of dam categories and sex of calves on BW. 
...
### Exercise 2
What are the mean, median, standard deviation, maximum, and minimum of age of dam categories?
```{r, eval=FALSE, echo=FALSE}
mean(dat$AgeDamCat)
...
### Exercise 3
What is the correlation between age of dams and BW?
```{r, eval=FALSE, echo=FALSE}
...
```{r, eval=FALSE}
fit <- lm(BW_205d ~ AgeDamCat + factor(Sex), data=dat)
summary(fit)
residuals(fit)
```
