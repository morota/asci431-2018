...
### Exercise 1
What is the estimate of heritability? Compare the estimate with the one we obtained from [intraclass correlation](http://morotalab.org/asci431-2017/day10/day10.html) using the sire model. 
...
```{r, eval=FALSE, echo=FALSE}
plot(uhatA, y, xlab="Estimated breeding values", ylab="Observed values")
abline(lm(y ~ uhatA), lwd=3, col="red") 
```
...
# Save as R object
```{r, eval=FALSE}
save(uhatA, h2A, sigma2A, sigma2e, file="day17.Rda")
```
